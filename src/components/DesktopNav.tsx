...
const DesktopNav: FC = () => {
  ...
  return (
    <nav className="my-3 mx-20">
      <div className="NavFirst flex flex-row justify-between items-center text-center mb-2">
        <div className="flex justify-center items-center">
          ...
          <Button
            ...
            onClick={toggleTheme}
          >
            <img src={Icons[darkMode ? "Light" : "Dark"]} alt="Toggle Theme" />
          </Button>
        </div>
        <div className="LinkButton flex">
      ...
      <div className="NavSec flex justify-between items-center text-center mx-10 mt-2">
        ...
        <div className="LinkButton flex">
          {["درباره ما", "تماس", "محصول", "صفحه اصلی"].map((text, index) => (
            <NavButton
              key={index}
              text={text}
              onClick={
